...
<div class="row">
  ...
  <label class="col-1">Unit</label>
  <label class="col-2">Options</label>
  <label class="col-3">Min / Max / Div</label>
</div>
<footer id="footer_#D#">
<div class="row">
...
const char html_child_line[] PROGMEM = R"rawliteral(
  ...
  <label class="col-1">
    <input type="text" name="dev_#D#_childs_#C#_unit" value="%CNFC_UNIT%" readonly>
  </label>
  <label class="col-2">
    <input type="text" name="dev_#D#_childs_#C#_options" value="%CNFC_OPT%" readonly>
  </label>
  <label class="col-1">
    <input type="text" name="dev_#D#_childs_#C#_imin" value="%CNFC_IMIN%" readonly>
  </label>
  <label class="col-1">
    <input type="text" name="dev_#D#_childs_#C#_imax" value="%CNFC_IMAX%" readonly>
  </label>
  <label class="col-1">
    <input type="text" name="dev_#D#_childs_#C#_idiv" value="%CNFC_IDIV%" readonly>
  </label>
)rawliteral";
